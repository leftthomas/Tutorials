...
Previously in fully_neural_network.py, we trained fully connected networks to classify notMNIST characters.
...
# Convolutional networks are more expensive computationally, so we'll limit its depth and
...
# 把model的结构改成LeNet5的结构，或者加上Dropout，修改学习率
