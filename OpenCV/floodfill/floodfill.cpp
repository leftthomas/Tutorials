...
int main( int argc, char** argv )
{
    ...
    printf( "Hot keys: /n"
            ...
            "/tc - switch color/grayscale mode/n"//彩色还是黑白图像
            "/tm - switch mask mode/n"//掩码模式
            "/tr - restore the original image/n"//保存原始图像
            "/ts - use null-range floodfill/n"//点填充
    ...
    cvCvtColor( color_img, gray_img0, CV_BGR2GRAY );//二值化
